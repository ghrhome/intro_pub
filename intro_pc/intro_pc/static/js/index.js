...
var pageView=(function ($){
  ...
  */
        ...
        var scene = new ScrollMagic.Scene({triggerElement: "#trigger-0", duration: _height, triggerHook:0.2})
            .on("enter", function () {
        ...
        var scene4 = new ScrollMagic.Scene({triggerElement: "#trigger-4", duration: _height, triggerHook:0.5})
            .on("enter", function () {
                // trigger animation by changing inline style.
                //animateElem.style.backgroundColor = "grey";
